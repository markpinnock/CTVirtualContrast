...
class BaseTrainingLoop(abc.ABC):
    ...
    @abc.abstractmethod
    def _print_results(self, epoch, training):
        pass
...
class GANTrainingLoop(BaseTrainingLoop, abc.ABC):
    def __init__(self,
                 Model: object,
                 dataset: object,
                 train_generator: object,
...
class NonGANTrainingLoop(BaseTrainingLoop, abc.ABC):
    def __init__(self,
                 Model: object,
                 dataset: object,
                 train_generator: object,
    ...
    def _print_results(self, epoch, training):
        if training:
            print(f"Train epoch {epoch + 1}, L1: {self.Model.train_L1_metric.result()}")
        else:
            print(f"Val epoch {epoch + 1}, L1: {self.Model.val_L1_metric.result()}")
